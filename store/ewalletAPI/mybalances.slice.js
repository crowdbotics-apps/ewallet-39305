...
export const api_v1_mybalance_list = createAsyncThunk("mybalances/api_v1_mybalance_list", async payload => {
  const response = await apiService.api_v1_mybalance_list(payload);
  return response.data;
});
export const api_v1_mybalance_create = createAsyncThunk("mybalances/api_v1_mybalance_create", async payload => {
  const response = await apiService.api_v1_mybalance_create(payload);
  return response.data;
});
export const api_v1_mybalance_retrieve = createAsyncThunk("mybalances/api_v1_mybalance_retrieve", async payload => {
  const response = await apiService.api_v1_mybalance_retrieve(payload);
  return response.data;
});
export const api_v1_mybalance_update = createAsyncThunk("mybalances/api_v1_mybalance_update", async payload => {
  const response = await apiService.api_v1_mybalance_update(payload);
  return response.data;
});
export const api_v1_mybalance_partial_update = createAsyncThunk("mybalances/api_v1_mybalance_partial_update", async payload => {
  const response = await apiService.api_v1_mybalance_partial_update(payload);
  return response.data;
});
export const api_v1_mybalance_destroy = createAsyncThunk("mybalances/api_v1_mybalance_destroy", async payload => {
...
const mybalancesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_mybalance_list.pending, (state, action) => {

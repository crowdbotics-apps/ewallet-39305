...
function api_v1_notification_create(payload) {
  return ewalletAPI.post(`/api/v1/notification/`, payload.data)
}
...
function api_v1_notification_update(payload) {
  return ewalletAPI.put(`/api/v1/notification/${payload.id}/`, payload.data)
}
function api_v1_notification_partial_update(payload) {
  return ewalletAPI.patch(`/api/v1/notification/${payload.id}/`, payload.data)
}
...
function api_v1_payment_create(payload) {
  return ewalletAPI.post(`/api/v1/payment/`, payload.data)
}
...
function api_v1_payment_update(payload) {
  return ewalletAPI.put(`/api/v1/payment/${payload.id}/`, payload.data)
}
function api_v1_payment_partial_update(payload) {
  return ewalletAPI.patch(`/api/v1/payment/${payload.id}/`, payload.data)
}
